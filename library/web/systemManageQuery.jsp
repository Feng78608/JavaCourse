        ...
        <li style="height: 780px">
          ...
          <img src="css/images/<%=picture%>" style="width: 361px;height: 240px" class="img_li">
              ...
              <div class="info">
                  ...
                  <p>
                      <label class="label_input" style="border-top-right-radius: 5px;border-bottom-right-radius: 5px;width:270px">姓名:<%=reader.getRdName()%></label>
                  </p>
                  <p >
                  ...
                  <p>
                      <label class="label_input" style="border-top-right-radius: 5px;border-bottom-right-radius: 5px;width:270px">读者类型:<%=readerDao.codeToType(reader.getRdType())%></label>
                  </p>
                  <p>
                      <label class="label_input" style="border-top-right-radius: 5px;border-bottom-right-radius: 5px;width:270px">读者单位:<%=reader.getRdDept()%></label>
                  </p>
                  <p>
                      <label class="label_input" style="border-top-right-radius: 5px;border-bottom-right-radius: 5px;width:270px">联系电话:<%=reader.getRdName()%></label>
                  </p>
                  <p>
                      <label class="label_input" style="border-top-right-radius: 5px;border-bottom-right-radius: 5px;width:270px">电子邮箱:<%=reader.getRdEmail()%></label>
                  </p>
                  <p >
                  ...
                  <p>
                      <label class="label_input" style="border-top-right-radius: 5px;border-bottom-right-radius: 5px;width:270px">照片:<%=reader.getRdPhoto()%></label>
                  </p>
                  <p>
                  ...
                  <p>
                      ...
                      <input type="text" id="up_reader_role" name="up_reader_role" value="<%=readerDao.codeToRole(reader.getRdAdminRoles())%>" class="text"/>
                  </p>
             <%-- 库存数量--%>
