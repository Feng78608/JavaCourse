...
public class QueryReaderBySystem extends HttpServlet {//查询读者
        ...
        try {
            ...
            if(readers[0]!=0) {
                session.setAttribute("readers", readers);
                    response.getWriter().print("<script type='text/javascript'>window.parent.location.href='systemManageQuery.jsp';</script>");
            }else{
